<template>
	<div class="min-h-screen bg-red-500 flex">
		...
		<div class="p-8 flex-1 overflow-hidden">
			<h4 class="text-white font-medium font-inter mb-2 text-lg">
				Template
			</h4>
			<div class="text-white bg-gray-700 rounded-lg">
				<pre class="px-8 pt-8 w-full overflow-auto">
					<code lang="ts">
{{template}}
					</code>
			</pre>
			...
			<h4 class="text-white font-medium font-inter mb-2 text-lg mt-8">
				Script
			</h4>
			<div class="text-white bg-gray-700 rounded-lg">
				<pre class="px-8 pt-8">
...
const template = `<div class="min-h-screen bg-red-500 flex">
	<div
		class="w-20 hover:w-64 transition-all duration-700 bg-white py-4 overflow-hidden flex-none"
		@mouseover="isExpanded = true"
		@mouseleave="isExpanded = false"
